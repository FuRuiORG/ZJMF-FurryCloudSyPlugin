(function ($) {
    ...
    $.fn.Pagination = function (options) {
        ...
        do {
            ...
            pageListHtml += '<li class="page-list '+Selected+'"><a href="javascript:;">'+i+'</a></li>';
            i ++;
            // 判断显示页数
            // i 小于 当前页 + 页码浮动量
        ...
        let html = '<nav aria-label="Page navigation">' +
            '<ul class="pagination">' +
            '<li><a href="javascript:;" class="pager-item" aria-label="first" title="回到首页"><span aria-hidden="true">'+ options.first +'</span></a></li>' +
            '<li><a href="javascript:;" class="pager-item" aria-label="prev" title="上一页"><span aria-hidden="true">'+ options.prev +'</span></a></li>' +
            pageListHtml +
            '<li><a href="javascript:;" class="pager-item" aria-label="next" class="下一页"><span aria-hidden="true">'+ options.next +'</span></a></li>' +
            '<li><a href="javascript:;" class="pager-item" aria-label="last" title="前往尾页"><span aria-hidden="true">'+ options.last +'</span></a></li>' +
            '</ul></nav>';
